...
### /result/all
_Получение результатов всех опросов от всех пользователей_
...
### 1001 - Username or password incorrect
**Причины:**
...
### 1002 - Test does not exist 
**Причины:**
* Нет теста в базе данных 
* Тест в базе данных с пришедшим от клинта id не существует
